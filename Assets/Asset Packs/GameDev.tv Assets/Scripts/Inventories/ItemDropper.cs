...
namespace GameDevTV.Inventories
{
    ...
    public class ItemDropper : MonoBehaviour, ISaveable
    {
        ...
        private List<DropRecord> otherSceneDroppedItem = new List<DropRecord>();
        ...
        object ISaveable.CaptureState()
        {
            ...
            droppedItemsList.AddRange(otherSceneDroppedItem);
        ...
        void ISaveable.RestoreState(object state)
        {
            ...
            int buildIndex = SceneManager.GetActiveScene().buildIndex;
            otherSceneDroppedItem.Clear();

            foreach (var item in droppedItemsList)
            {
                if (item.sceneBuildIndex != buildIndex)
                {
                    otherSceneDroppedItem.Add(item);
                    continue;
                }
